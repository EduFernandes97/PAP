...
if (!isset($_SESSION['aluno'])) {
    ...
    echo "<h2>Avaliação Final do Professor Orientador de Estágio</h2>";

    return;
}
echo "<h2>Avaliação Final do Professor Orientador de Estágio</h2>";

$sql = "SELECT * FROM av_prof_total \n"
    . "WHERE num_processo = " . $_SESSION['aluno'] . " and email_prof = '" . $_SESSION['email'] . "' and cod_anoLetivo = " . $_SESSION['ano'];
...
$sql = "SELECT av_prof.nota, av_prof.num_objetivo_final, objetivo_final.dominio, objetivo_final.objetivo FROM aluno
  JOIN objetivo_final ON objetivo_final.cod_curso = aluno.cod_curso
  join av_prof on av_prof.num_objetivo_final = objetivo_final.num_objetivo_final and av_prof.num_processo = aluno.num_processo
  WHERE aluno.num_processo = " . $_SESSION['aluno'] . "  and aluno.cod_anoLetivo =" . $_SESSION['ano'] . " and av_prof.cod_anoLetivo =" . $_SESSION['ano']. " and objetivo_final.cod_anoLetivo = " . $_SESSION['ano']."  order by dominio";
...
<textarea maxlength='500' name='obs_prof' style='height:135px;width:900px;''>".$dados_total['observacao']."</textarea>";
		...
		";
                ...
                <tr>
                    ...
                    <td><?php echo $objetivos["objetivo"] ?></td>
                    <td align="center"><input name='nota[<?php echo $objetivos["num_objetivo_final"] ?>]' type='number'
                                              min =  '1' max='5'></td>
                </tr>
		...
		<b>5</b> - Muito Bom</td>
                ...
                echo "<br>
<br>
Observações do Professor Orientador de Estágio:
<br>
<textarea maxlength='500' name='obs_prof' style='height:135px;width:900px;''></textarea>";
                if ($num_objetivo == 0) {
