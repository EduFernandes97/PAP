    ...
    <form  class="pure-form" onsubmit="atualiza_plano(<?php echo $dados["cod_plano"]; ?>);return false;">
        <table border=0>
            <tr>
                ...
                <td><input name="duracao_estagio" type="text" value="<?php echo $dados["duracao_estagio"] ?>"></td>
            </tr>
            <tr>
                <td>Dia(s) da Semana:</td>
                <td><input name="dias_semana" type="text" value="<?php echo $dados["dias_semana"] ?>"></td>
            </tr>
            <tr>
                <td>Período de Estágio:</td>
                <td> de <input name="periodo_estagio1" type="date" value="<?php echo $dados["periodo_estagio1"] ?>">
                </td>
                <td> a <input type="date" name="periodo_estagio2" value="<?php echo $dados["periodo_estagio2"] ?>"></td>
            </tr>
            <tr>
        ...
        <table border=0>
            <tr>
                ...
                <td><input type="number" name="num_visitas" value="<?php echo $dados["num_visitas"] ?>"></td>
            </tr>
            <tr>
                <td>Na Escola:</td>
                <td><input type="number" name="num_visitas_escola" value="<?php echo $dados["num_visitas_escola"] ?>">
                </td>
            </tr>
            <tr>
                <td>Na Entidade de Estágio:</td>
                <td><input type="number" name="num_visitas_estagio" value="<?php echo $dados["num_visitas_estagio"] ?>">
                </td>
            </tr>
        ...
        <textarea style="height:135px;width:900px;" name="objetivos"><?php echo $dados["objetivos"] ?></textarea>

        <h5>Conteudos a abordar</h5>
        <textarea style="height:105px;width:900px;" name="conteudos"><?php echo $dados["conteudos"] ?></textarea>
    </form>
<?php
    ...
    <form  class="pure-form" onsubmit="novo_plano();return false;">
        <table border=0>
            <tr>
                <td>Duração do Estágio:</td>
                <td><input name="duracao_estagio" type="text"></td>
            </tr>
            <tr>
                <td>Dia(s) da Semana:</td>
                <td><input name="dias_semana" type="text"></td>
            </tr>
            <tr>
                <td>Período de Estágio:</td>
                <td> de <input name="periodo_estagio1" type="date"></td>
                <td> a <input type="date" name="periodo_estagio2"></td>
            </tr>
            <tr>
                <td>Horário Diário:</td>
        ...
        <table border=0>
            <tr>
                <td>Número de visitas de acompanhamento <br>pelo professor orientador de estágio:</td>
                <td><input type="number" name="num_visitas"></td>
            </tr>
            <tr>
                <td>Na Escola:</td>
                <td><input type="number" name="num_visitas_escola"></td>
            </tr>
            <tr>
                <td>Na Entidade de Estágio:</td>
                <td><input type="number" name="num_visitas_estagio"></td>
            </tr>
        ...
        <h5>Objetivos Específicos</h5>
        <textarea style="height:135px;width:900px;" name="objetivos" id="obje"></textarea>

        <h5>Conteudos a abordar</h5>
        <textarea style="height:105px;width:900px;" name="conteudos" id="conte"></textarea>
    </form>
<?php } ?>