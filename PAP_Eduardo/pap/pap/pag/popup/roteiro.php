...
<table border=0 id="tab_roteiro">
    ...
    $ano = $_SESSION["ano"] - 1;
    $sql = "SELECT * FROM roteiro_atividade where num_processo='" . $_SESSION["num_proc"] . "' and cod_anoLetivo=" . $ano;
    ...
    if ($num_linha != 0) {
        for ($i = 0; $i < $num_linha; $i++) {
            ...
            echo "<tr>
					<td>" . $z . "</td>
					<td><textarea readonly style='height:100px;width:600px;' onKeyPress='mostra_edita(" . $z . ")' name='atividade" . $z . "'>" . $dados["atividade"] . "</textarea></td>
        ...
        echo "<tr>
				<td>1</td>
				<td><textarea readonly style='height:100px;width:600px;' name='atividade1'></textarea></td>
